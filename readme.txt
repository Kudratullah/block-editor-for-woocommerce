...
2. Search for ‘WooCommerce Block Editor’
3. Activate ‘WooCommerce Block Editor’ plugin

### Install From The Zip Archive

1. Download WooCommerce Block Editor from WordPress plugin page
2. Visit the plugins page within your dashboard and select ‘Add New’
3. Click ‘Upload Plugin’
4. Click ‘Choose File’
5. Click ‘Install Now’
6. Activate the ‘WooCommerce Block Editor’ plugin

### Install WooCommerce Block Editor Manually

1. Upload the ‘woocommerce-block-editor’ folder to the /wp-content/plugins/ directory
2. Activate the ‘WooCommerce Block Editor’ plugin
